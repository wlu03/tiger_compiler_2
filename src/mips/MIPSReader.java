...
public class MIPSReader {
    ...
    // operands
    private static String registerPat = "\\$[a-zA-Z0-9_-]+|zero";
    ...
    private static String addrRegisterPat = "\\((\\$[a-zA-Z0-9_-]+|zero)\\)";
    private static String addrBaseOffPat = "(0x[a-fA-F0-9]+|-?[0-9]+)\\((\\$[a-zA-Z0-9-_]+|zero)\\)";
